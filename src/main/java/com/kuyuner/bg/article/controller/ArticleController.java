...
public class ArticleController extends BaseController {
    ...
    public ResultJson listDispatch(String userId) {
    ...
    public ResultJson listBusiness(String userId) {
        return articleService.getBusiness(UserUtils.getPrincipal() == null ? userId : UserUtils.getPrincipal().getId());
    }
    ...
    public ResultJson listPurchase(String userId) {
        return articleService.getPurchase(UserUtils.getPrincipal() == null ? userId : UserUtils.getPrincipal().getId());
    }
    ...
    public ResultJson listEmail(String userId) {
        return articleService.getEmail(UserUtils.getPrincipal() == null ? userId : UserUtils.getPrincipal().getId());
    }
    ...
    @ApiOperation(value = "代办数量")
    @ResponseBody
    @RequestMapping("/needHandle")
    public ResultJson needHandle(String userId) {
        NeedHandleCount result = articleService.needHandle(UserUtils.getPrincipal() == null ? userId : UserUtils.getPrincipal().getId());
        return ResultJson.ok(result);
    }
}