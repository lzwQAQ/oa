package com.kuyuner.common.media;

import com.kuyuner.common.collect.ListUtils;
...
import com.kuyuner.common.lang.TimeUtils;
...
public class VideoUtils {
    ...
    public static String getFfmpegFile() {
        if (ffmpegFile == null) {
            ffmpegFile = PropertiesUtils.getProperty("video.ffmpegFile");
        }
        return ffmpegFile;
    }
    ...
    public static String getMencoderFile() {
        if (mencoderFile == null) {
            mencoderFile = PropertiesUtils.getProperty("video.mencoderFile");
        }
        return mencoderFile;
    }
    ...
    public static String getQtFaststartFile() {
        if (qtFaststartFile == null) {
            qtFaststartFile = PropertiesUtils.getProperty("video.qtFaststartFile");
        }
