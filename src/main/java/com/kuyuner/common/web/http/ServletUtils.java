package com.kuyuner.common.web.http;

import com.kuyuner.common.collect.MapUtils;
import com.kuyuner.common.io.PropertiesUtils;
import com.kuyuner.common.lang.StringUtils;
import com.kuyuner.common.mapper.JsonMapper;
import com.kuyuner.common.mapper.XmlMapper;
...
public class ServletUtils {
    ...
    public static boolean isStaticFile(String uri) {
        if (staticFiles == null) {
            try {
                staticFiles = StringUtils.split(PropertiesUtils.getProperty("web.staticFile"), ",");
                staticFileExcludeUri = StringUtils.split(PropertiesUtils.getProperty("web.staticFileExcludeUri"), ",");
    ...
    public static Map<String, Object> getExtParams(ServletRequest request) {
        ...
        if (StringUtils.isNotBlank(params) && StringUtils.startsWith(params, "{")) {
            paramMap = JsonMapper.fromJsonString(params, Map.class);
        } else {
