$(function () {
    ...
    $("#table").on("click", ".edit-item", function () {
        ...
        Util.innerIframe(Util.getPath() + "/car/form/" + id);
    });
    ...
    $("#btn-add").click(function () {
        Util.innerIframe(Util.getPath() + "/car/form");
    });
	...
	function deletes(ids) {
        Util.ask("确定删除？", function (index) {
            ...
            Util.postLoading(Util.getPath() + "/car/deletes", {ids: ids}, function (res) {
                if (res.code === 200) {
                    Util.msgOk("删除成功！");
                    gridTable.trigger("reloadGrid");
                } else {
